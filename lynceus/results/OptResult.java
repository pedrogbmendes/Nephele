   ...
   public double getEstimationError() {
	...
	public String toString() {
		return "OptResult [opt=" + opt + ", explCost=" + explCost + ", explTimeTaken=" + explTimeTaken
				...
				+ distFromOpt + ", initDistFromOpt=" + initDistFromOpt + ", finalConfig=" + finalConfig + ", seed="
				+ seed + ", initTain=" + initTain + ", horizon=" + horizon + ", gaussHermitPoints=" + gaussHermitPoints
				+ ", epsilon=" + epsilon + ", budget=" + budget + ", withinTmax=" + withinTmax + ", estimationError="
				+ estimationError + ", numTimeouts=" + numTimeouts + ", nexToOpt=" + nexToOpt + "]";
	}
