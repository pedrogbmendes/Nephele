...
public class ExtendedGiraphLHS<C extends Configuration> extends LHS {

	/* class attributes */
	private ArrayList<double[]> dims;
	
	public ExtendedGiraphLHS(int samples) {
		super(samples);
	}
...
//			System.out.println(i);
		...
		ExtendedGiraphConfig config = new ExtendedGiraphConfig(flavor, workers, mem, totalCores, graph, ExtendedWekaGiraphConfigFactory.wkld);
		
		return new ExtendedWekaGiraphConfig(config, super.dataset);
	}
