 ...
 * @since 24.04.18
 */
public class ExtendedScoutVMConfig implements Configuration {
   ...
   /* class constructors */
   public ExtendedScoutVMConfig(AWSDirectory.AWSInstanceType type, AWSDirectory.AWSInstanceSize size, double vcpus, double ecus, double frequency, double ram, double ebs_band, String net_band, double num_instances) {
      this.type = type;
      this.size = size;
      this.vcpus = vcpus;
      this.ecus = ecus;
   ...
   public Configuration clone() {
      return new ExtendedScoutVMConfig(this.type, this.size, this.vcpus, this.ecus, this.frequency, this.ram,this.ebs_band,this.net_band, this.num_instances);
   }
   ...
   public boolean equals(Object o) {
      ...
      ExtendedScoutVMConfig that = (ExtendedScoutVMConfig) o;
   ...
   public static ExtendedScoutVMConfig  parseName(String name) {
         ...
         return new ExtendedScoutVMConfig(type, size, cpus, ecus, hz, ram, ebs, net, numInstances);
   }
