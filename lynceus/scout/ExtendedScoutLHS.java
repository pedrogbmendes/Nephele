...
public class ExtendedScoutLHS <C extends Configuration> extends LHS{
	...
	/* class constructor */
	public ExtendedScoutLHS(int samples) {
		super(samples);
	}
	...
	protected Configuration newSample(int index) {
		...
		ExtendedScoutVMConfig newConfig = new ExtendedScoutVMConfig(type, size, vcpus, ecus, frequency, ram, ebs_band, net_band, num_instances);
		//System.out.println("newConfig = " + newConfig);
		
		return new ExtendedWekaScoutVMConfig(newConfig, super.dataset);
	}
