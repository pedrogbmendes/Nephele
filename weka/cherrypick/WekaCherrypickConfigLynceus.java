...
public class WekaCherrypickConfigLynceus extends Lynceus<CherrypickConfig, WekaModelSample> {
	...
	public WekaCherrypickConfigLynceus(long h, double b, double epsilon, double gamma, optimizer opt, long wkldid) {
	...
	@Override
	protected PredictiveModel<CherrypickConfig, WekaModelSample> buildPredictiveModel(
			TrainingSet<CherrypickConfig, WekaModelSample> trainingSet, ModelParams params,TestSet<CherrypickConfig, WekaModelSample> testSet, long seed) {
