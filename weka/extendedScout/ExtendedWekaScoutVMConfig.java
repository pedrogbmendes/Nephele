 ...
 * @since 12.03.18
 */
public class ExtendedWekaScoutVMConfig extends ExtendedScoutVMConfig implements WekaConfiguration {

   @Override
   public ExtendedWekaScoutVMConfig clone() {
      return new ExtendedWekaScoutVMConfig(this, this.dataSet);   //NB: this is *not* copying the instances
   }

   private Instances dataSet; //this is only for creating instances

   public ExtendedWekaScoutVMConfig(Instance i) {
   ...
   public ExtendedWekaScoutVMConfig(ExtendedScoutVMConfig c, Instances d) {
