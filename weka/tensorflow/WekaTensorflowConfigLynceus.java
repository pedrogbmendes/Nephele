...
public class WekaTensorflowConfigLynceus extends Lynceus<TensorflowConfig, WekaModelSample>{
	...
	/* class constructor */
	public WekaTensorflowConfigLynceus(long h, double b, double epsilon, double gamma, optimizer opt, long wkldid) {
	...
	@Override
	protected PredictiveModel<TensorflowConfig, WekaModelSample> buildPredictiveModel(TrainingSet<TensorflowConfig, WekaModelSample> trainingSet, ModelParams params,TestSet<TensorflowConfig, WekaModelSample> testSet, long seed) {
